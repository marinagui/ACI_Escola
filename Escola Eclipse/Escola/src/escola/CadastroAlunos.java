...
"            </div>");
            ...
            out.println("<div class='field'><label for='responsavel'>Responsável:</label><input type='text' class='input' name='responsavel' id='responsavel' maxlength='50'/><p class='hint'>Insira o nome de seu responsável</p></div>");
