...
public class EditarResponsavel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
	        ...
	        out.println("<html>");
	        out.println("<head>");
	        out.println("<title>Edição de Responsáveis</title>"); 
	        ...
	        if(request.getParameter("emailResp")!=null){
	        	if(request.getParameter("nomeResp")!=null){
		        	...
		        	try{
			        	...
			        	out.println("<div class='mensagem'>O Responsável Foi Editado Com Sucesso</div>");
	        			...
	        			out.println("<div class='field' style='display:none;'><label for='emailResp'>Email:</label><input type='text' value='"+emailResp+"' class='input' name='emailResp' id='emailResp' maxlength='100'/><p class='hint'>Insira seu email</p></div>");
	        		...
	        		try{
	        			...
	        			Responsaveis resp = new Responsaveis();
	        			responsavelParaEditar  = resp.getResponsavel(emailResp);
	        		}catch(Exception e){
	        			out.println("<div class='mensagem'>"+e.getMessage() +"</div");
